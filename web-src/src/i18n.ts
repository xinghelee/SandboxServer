...
const EN: Dict = {
  ...
  'mcp.step1.sub': 'Run doctor first. It verifies the host, port, token, and SDK identity before you add the server to a client.',
...
const ZH: Dict = {
  ...
  'mcp.tools': '{n} 个工具',
  'mcp.step1': '1. 检查桥接',
  'mcp.step1.sub': '先运行 doctor。它会在加入客户端前检查 host、port、token 和 SDK 身份。',
